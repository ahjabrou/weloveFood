...
if (isset($_POST['fonction'])) {
  ...
  ORDER BY p.datepub DESC LIMIT $show WHERE fonction = '$fonction'";
...
if (isset($_GET['query'])) {
  ...
  $sql = "SELECT * FROM `publicationtwo` WHERE titre LIKE '%$query%' OR fonction LIKE '%$query%' OR texte LIKE '%$query%' OR imagepub LIKE '%$query%'";
